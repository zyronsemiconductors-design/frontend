export const coursesFullContent: Record<string, string[]> = {
  ...
  "physical-design-training": [
    ...
    "Timing Reports",
    "An analysingPD Flow Stage Timing Reports",
    ...
    "Engineering changeorder Flow (ECO)",
    "Functional ECO",
    "Timing ECO",
  ...
  "vlsi-design-verification": [
    ...
    "Combinational logic coding: Half adder, full adder, multiplexer, comparator, encoder, decoder, priorityencoder",
    "Generate",
  ...
  "mtech-project-internship": [
    ...
    "One year time spent on MTech project gives ample time to the student to work on complex projects inline with industry requirements. It helps student improve the resume and overall skillset, ultimately helping in getting a right job.",
    ...
    "PLI",
    "compiler directives",
    "Verilog Designand Verification Multiple Projects",
    "DFF coding using gate level, behavioural",
    "Counters",
    "Up counter",
    "Ring counter",
    ...
    "Narrow transfers",
    "Data bus and strobe relation",
    "Aligned and unaligned transfersAXI signal encoding",
    "Responses in AXI",
    "Locked and exclusive transfers",
    "Overlapping, out of order, interleaved txs",
    "Interconnect role in out of order transaction",
  ...
  "amba-protocol-training": [
    ...
    "AtZyron semi-conductors, we believe that education should lead to meaningful employment. Our training programs are designed not just to impart technical excellence, but also to bridge the gap between academic learning and industry demands. With a strong network of hiring partners and a proven track record, we ensure that our students are career-ready.",
  ...
  "gvim-training": [
    ...
    "how to move to 1st line(gg), how to move to last line of the file(G)",
    "end of the line(end), beginning of the line(0), next word(w), end of the word(e), previousword(b)",
