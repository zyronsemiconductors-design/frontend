    ...
    services: [
        ...
        },
        {
            ...
            content: [
                ...
                "Courses:",
                "Design and Verification Engineer (DV) - 6 months",
                ...
                "• Real-time projects",
                "Design for Testability Engineer (DFT) - 6 months",
                "• DFT fundamentals",
                ...
                "Physical Design Engineer (PD) - 6 months",
    ...
    nav: {
        ...
        services: [
            ...
            { label: "Staff Augmentation", to: "/services#staff" },
            {
                ...
                children: [
                    { label: "Design & Verification Engineer (DV) – 6 Months", to: "/services#training" },
                    { label: "Design for Testability Engineer (DFT) – 6 Months", to: "/services#training" },
                    { label: "Physical Design Engineer (PD) – 6 Months", to: "/services#training" },
                    { label: "RTL Design Engineer – 6 Months", to: "/services#training" },
                ],
            },
        ],
        why: [
